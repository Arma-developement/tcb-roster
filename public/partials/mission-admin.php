...
function tcbp_public_mission_send_announcement( $post_id ) {
	...
	// Training missions are members-only - recruits/candidates aren't eligible, so don't ping them.
	$mentions     = has_term( 'training', 'event_category', $post_id ) ? '{@members}' : '{@members} {@recruits} {@candidate}';
